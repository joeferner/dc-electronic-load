...
struct flashFile flashFiles[] = {
  ...
  { .filename = "/js/dc-electronic-load.js", .content_type = mimetype_application_javascript, .offset = 192861, .size = 3635, .script = serve_flash_file },
  { .filename = "/css/dc-electronic-load.css", .content_type = mimetype_text_css, .offset = 196496, .size = 87, .script = serve_flash_file },
  { .filename = "/css/bootstrap.min.css", .content_type = mimetype_text_css, .offset = 196583, .size = 109518, .script = serve_flash_file },
  { .filename = "/img/glyphicons-halflings.png", .content_type = mimetype_image_png, .offset = 306101, .size = 12799, .script = serve_flash_file },
  { .filename = "/img/glyphicons-halflings-white.png", .content_type = mimetype_image_png, .offset = 318900, .size = 8777, .script = serve_flash_file },
  { .filename = "/amps/set", .content_type = mimetype_text_html, .offset = 327677, .size = 0, .script = serve_amps_set },
  { .filename = "/ws", .content_type = mimetype_text_html, .offset = 327677, .size = 0, .script = serve_web_socket },
  { .filename = "/index.html", .content_type = mimetype_text_html, .offset = 327677, .size = 2654, .script = serve_flash_file },
