...
struct flashFile flashFiles[] = {
  ...
  { .filename = "/js/dc-electronic-load.js", .content_type = mimetype_application_javascript, .offset = 192861, .size = 4879, .script = serve_flash_file },
  { .filename = "/css/dc-electronic-load.css", .content_type = mimetype_text_css, .offset = 197740, .size = 87, .script = serve_flash_file },
  { .filename = "/css/bootstrap.min.css", .content_type = mimetype_text_css, .offset = 197827, .size = 109518, .script = serve_flash_file },
